...
describe('Central de Atendimento ao Cliente TAT', function() {
    ...
    it('exibe mensagem de erro ao submeter o formulário com um email com formatação inválida', function() {
        ...
        cy.get('#lastName').type('Paes')
        cy.get('#email').type('mirella@mailinator,com')
        cy.get('#open-text-area').type('Um cavalo morto é um animal sem vida')
        cy.contains('button', 'Enviar').click()
    ...
    it('preenche e limpa os campos nome, sobrenome, email e telefone', function() {
        ...
        cy.get('#lastName')
            .type('Paes')
            .should('have.value', 'Paes')
            .clear()
            .should('have.value', '')
        cy.get('#email')
            .type('mirella@mailinator.com')
            .should('have.value', 'mirella@mailinator.com')
            .clear()
            .should('have.value', '')
        cy.get('#phone')
            .type('1234567890')
...
//------------------------- Aula 6 -------------------------------------
    ...
    it('preenche a area de texto usando o comando invoke', function() {
        const longText = Cypress._.repeat('Um cavalo morto é um animal sem vida...\n', 5)
